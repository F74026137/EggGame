...
//	int goal=20;   //測試用
	...
	//計時--------------
//	JButton start ;
	public static JTextPane timer;		
	//-------------
	protected static Cooking frame = new Cooking();
...
//		Cooking frame = new Cooking();
	...
	public Cooking(){
		...
		ImageIcon background = new ImageIcon("src/Chihane1002/bg.png");	
		...
		rule_icon = new ImageIcon("src/Chihane1002/rule.png");
		bag_icon = new ImageIcon("src/Chihane1002/bag.png");
		bowl_icon = new ImageIcon("src/Chihane1002/bowl.png");
		spoon_icon = new ImageIcon("src/Chihane1002/spoon.png");
		spoonBig_icon = new ImageIcon("src/Chihane1002/spoonBig.png");
		//計時
...
//----------------------------------------------------------------------
	...
	private void mouse(){
		//另外改變滑鼠圖標請套用以下設定:
		try {
			c = ImageIO.read(new File("src/Chihane1002/spoon_mouse.png"));
	...
	private void judge(int bowl){
		if(bowl==goal){
			...
			ImageIcon bgDone = new ImageIcon("src/Chihane1002/done.png");	
