...
public class PaperScissorsStone extends JFrame implements ActionListener{
	private static final long serialVersionUID = 1L;//default ID
	Random random = new Random();//電腦出拳=隨機
	static int round = 3;//有#define的寫法嗎?
	static int cnt=1,win=0,lost=0,same=0,result=0;//計分
	static int input=0,output=0;//兩方出拳
	/*
	 * 剪刀=1 石頭=2布 =3
	 * 1>3
	 * 2>1
	...
	protected static PaperScissorsStone frame = new PaperScissorsStone();
	public static void main(String[] args){
		PaperScissorsStone frame = new PaperScissorsStone();
	...
	public PaperScissorsStone(){
		...
		ImageIcon background = new ImageIcon("src/Chihane1002/bgPSS.png");	
		...
		rule_icon = new ImageIcon("src/Chihane1002/rulePSS.png");
		icon1 = new ImageIcon("src/Chihane1002/scissors.png");
		icon2 = new ImageIcon("src/Chihane1002/stone.png");
		icon3 = new ImageIcon("src/Chihane1002/paper.png");
	...
	private void isEnd(){
		if((win==round)||(lost==round)){
			...
			if(win==round){
				...
				ImageIcon bgDone = new ImageIcon("src/Chihane1002/winPSS.png");	
				...
				ImageIcon bgLost = new ImageIcon("src/Chihane1002/lostPSS.png");	
